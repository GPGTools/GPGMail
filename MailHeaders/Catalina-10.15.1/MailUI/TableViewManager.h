...
- (void)selectMessage:(id)arg1 options:(unsigned long long)arg2 completionBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010029ee13
...
- (void)_selectMessages:(id)arg1 scrollIfNeeded:(BOOL)arg2 options:(unsigned long long)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000010029e9f7
...
- (BOOL)hideMessages:(id)arg1 selectingNextMessage:(BOOL)arg2 withAnimationOptions:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001002990b9
