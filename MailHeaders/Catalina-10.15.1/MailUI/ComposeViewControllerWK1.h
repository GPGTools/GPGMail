...
- (void)_restoreOriginalAttachments:(CDUnknownBlockType)arg1;	// IMP=0x0000000100105acf
...
- (void)continueLoadingInitialContent:(CDUnknownBlockType)arg1;	// IMP=0x0000000100102bd0
