...
- (void)_deferOrExecuteAction:(CDUnknownBlockType)arg1 forProvider:(id)arg2;	// IMP=0x00000001001e568f
...
- (void)getIndexesOfMessages:(id)arg1 options:(unsigned long long)arg2 completionBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000001001e3e97
...
- (void)sendResponseType:(BOOL)arg1 forMeetingMessage:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001e35ce
...
- (void)hideMessages:(id)arg1 selectingNextMessage:(id)arg2 withAnimationOptions:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001001e0da0
