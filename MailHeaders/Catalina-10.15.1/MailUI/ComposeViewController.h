...
- (void)getSnapshotParts:(CDUnknownBlockType)arg1;	// IMP=0x00000001000ffce9
...
- (void)_restoreOriginalAttachments:(CDUnknownBlockType)arg1;	// IMP=0x00000001000ff41b
...
- (void)canClose:(CDUnknownBlockType)arg1;	// IMP=0x00000001000fb4ef
...
- (void)continueLoadingInitialContent:(CDUnknownBlockType)arg1;	// IMP=0x00000001000f1797
