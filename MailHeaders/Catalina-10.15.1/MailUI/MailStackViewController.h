...
- (void)mui_prepareToLayoutSynchronously:(CDUnknownBlockType)arg1;	// IMP=0x00000001001ca86d
- (void)mui_performAnimation;	// IMP=0x00000001001ca201
- (void)mui_prepareToAnimate:(CDUnknownBlockType)arg1;	// IMP=0x00000001001ca14d
...
- (void)_takeSnapshotOfMessageViewForController:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001001c8efa
