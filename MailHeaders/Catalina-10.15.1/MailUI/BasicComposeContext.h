...
- (void)presentComposeViewController:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000c6181
- (void)loadCompleted:(id)arg1;	// IMP=0x00000001000c617b
- (void)controllerInitialized:(id)arg1;	// IMP=0x00000001000c6175
- (void)generateQuotedContentWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000c5f82
