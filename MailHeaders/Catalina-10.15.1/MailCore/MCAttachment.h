...
- (void)dataForAccessLevel:(long long)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000004115e
- (id)dataForAccessLevel:(long long)arg1;	// IMP=0x0000000000040eb1
@property(retain, nonatomic) NSData *cachedFetchedData;
- (void)fileWrapperForAccessLevel:(long long)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000040912
