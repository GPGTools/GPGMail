...
@interface MCRemoteURLAttachmentDataSource : NSObject <NSURLSessionDownloadDelegate, MCAttachmentDataSource>
{
    ...
    CDUnknownBlockType _fileWrapperCompletionBlock;	// 72 = 0x48
...
- (void)fileWrapperForAccessLevel:(long long)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000008e4d3
- (void)dataForAccessLevel:(long long)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000008e341
