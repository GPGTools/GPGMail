...
+ (id)_specialMailboxesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000146abd
...
- (void)promptUserForDeletionInWindow:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000014b4ac
...
- (BOOL)_performBlock:(CDUnknownBlockType)arg1 forMessagesFetchedWithBlock:(CDUnknownBlockType)arg2 withBatchSize:(unsigned long long)arg3;	// IMP=0x000000000014772e
