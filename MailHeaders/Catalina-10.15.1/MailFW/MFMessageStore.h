...
+ (id)_copyRawAvailableStoreForMailbox:(id)arg1 creationBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000001a0646
...
- (void)sendResponseType:(BOOL)arg1 forMeetingMessage:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001a6622
