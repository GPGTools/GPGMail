...
- (void)performBlockDeferringMessageNotifications:(CDUnknownBlockType)arg1;	// IMP=0x0000000000107f56
- (void)queueConversationFlagsChangedNotification:(id)arg1;	// IMP=0x0000000000107e30
- (void)queueStoreFinishedFirstTimeSyncWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000107e17
...
- (id)allMailboxesSearchableIndexQueryWithExpression:(id)arg1 builder:(CDUnknownBlockType)arg2 forUnreadCount:(BOOL)arg3 withMailboxExclusions:(BOOL)arg4 includeAttachmentCriterion:(BOOL)arg5;	// IMP=0x00000000000faa0a
...
- (id)_scopeIdentifiersForCriterion:(id)arg1 criterionIdentifierMapper:(CDUnknownBlockType)arg2 allCriteriaAreMailbox:(char *)arg3;	// IMP=0x00000000000fa011
...
- (id)mimeMessageDataSnippingPartsData:(id)arg1 mimePartBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f799d
...
- (void)fileURLForAttachmentID:(id)arg1 messageID:(id)arg2 name:(id)arg3 result:(CDUnknownBlockType)arg4;	// IMP=0x00000000000f4521
...
- (long long)_addMessageToCountContext:(CDStruct_33dcf794 *)arg1 statement:(id)arg2;	// IMP=0x00000000000e9d12
...
- (CDStruct_f4b747e6)messageColorForLibraryMessageColor:(char *)arg1;	// IMP=0x00000000000e52b0
- (char *)libraryMessageColorForMessageColor:(CDStruct_f4b747e6)arg1;	// IMP=0x00000000000e5251
