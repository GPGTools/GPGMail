...
- (void)_attachmentsForAccounts:(id)arg1 startTimeInterval:(double)arg2 endTimeInterval:(double)arg3 withBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000002d04f
- (long long)_monthsToKeepRecentAttachments;	// IMP=0x000000000002d023
- (void)_attachmentsForAccounts:(id)arg1 minimumCachePolicy:(long long)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000002ce3e
