...
+ (id)queryResultCollectorWithExpression:(id)arg1 processor:(id)arg2 builder:(CDUnknownBlockType)arg3;	// IMP=0x00000000001fe509
...
- (id)initWithExpression:(id)arg1 processor:(id)arg2 builder:(CDUnknownBlockType)arg3;	// IMP=0x00000000001fe5a0
