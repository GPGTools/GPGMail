...
+ (BOOL)upgradeSmartMailboxesInMigrationDirectory:(long long)arg1 withUpgrader:(CDUnknownBlockType)arg2;	// IMP=0x00000000001d2fec
+ (BOOL)upgradeSyncedRulesInMigrationDirectory:(long long)arg1 withUpgrader:(CDUnknownBlockType)arg2;	// IMP=0x00000000001d2cd7
+ (BOOL)upgradeUnsyncedRulesInMigrationDirectory:(long long)arg1 withUpgrader:(CDUnknownBlockType)arg2;	// IMP=0x00000000001d29e4
