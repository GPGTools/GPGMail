...
+ (id)onScheduler:(id)arg1 requestContentForObjectID:(id)arg2 legacyMessage:(id)arg3 messageTransformer:(id)arg4 clientIdentifier:(id)arg5 options:(id)arg6 delegate:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;	// IMP=0x0000000000177961
...
- (id)requestRawRepresentationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000177c6e
- (id)beginRequestWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000177b16
